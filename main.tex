  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {}{Apr 2022 \textbf{--} Present}
        \resumeItemListStart
            \resumeItem{Working on procedural generation of new levels for platformer-based games using gameplay video. The main purpose of this research is to propose a new method of generating levels for unseen games without annotated datasets - Under supervision of Prof. Matthew Guzdial}
        \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      {}{Jun 2019 \textbf{--} Aug 2019}
        \resumeItemListStart
            \resumeItem{Worked on predicting award winner books of Goodreads website using various machine learning techniques. For this project, a tabular dataset was created by crawling book information from the Goodreads Website - Under the supervision of Prof. Behnam Bahrak}
        \resumeItemListEnd
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {}{Jul 2018 \textbf{--} Oct 2018}
        \resumeItemListStart
            \resumeItem{Worked on the implementation of genetic, memetic, artificial bee colony, simulated annealing, and firefly algorithms for the problem of server placement optimization.}
        \resumeItemListEnd
    ...
    \resumeSubHeadingListStart
      ...
      \resumeProjectHeading
        {\textbf{Server Placement Optimization} $|$ \emph{\href{https://github.com/NegarMirgati/Sever-Placement-Optimization}{\color{PineGreen}GitHub}}}{}
          \resumeItemListStart
            \resumeItem{Implementation of nature-based algorithm for the problem of server placement optimization (Implemented in Python) - Summer internship project @ IPM}
          \resumeItemListEnd
      
      \resumeProjectHeading
        {\textbf{MAPVis} $|$ \emph{\href{https://github.com/NegarMirgati/MAPVis}{\color{PineGreen}GitHub}}}{}
          \resumeItemListStart
            \resumeItem{A web-bsaed interface used for visualizing the Maximum A-posteriori Estimation (MAP) in data communication (Implemented using Javascript and HTML/CSS)}
            \resumeItem{The purpose of developing this tool was to help the data communication course students understand the above-mentioned concept.}
          \resumeItemListEnd
